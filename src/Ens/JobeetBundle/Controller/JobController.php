...
use Ens\JobeetBundle\Repository\CategoryRepository;
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $job = array(
            ...
            'company_slug' => $entity->getCompanySlug(),
            'location_slug' => $entity->getLocationSlug(),
            'position_slug' => $entity->getPositionSlug()
        );
    ...
    public function previewAction($token) {
        ...
        $publishForm = $token->createPublishForm($entity->getToken());

        return $this->render('EnsJobeetBundle:Job:show.html.twig' ,array(
            'entity' => $entity,
            'delete_form' => $deleteForm->createView(),
            'publish_form' => $publishForm->creareView(),
        ));
    }
